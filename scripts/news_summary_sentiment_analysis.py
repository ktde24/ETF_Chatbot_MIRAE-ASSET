...
# ── 레벨별 스타일 프롬프트 ───────────────────────────────────
LEVEL_PROMPTS = {
    1: "- Level 1: 유치원/초1 스타일로 아주 쉽게, 비유와 예시 위주로 2줄로 요약하세요.",
    2: "- Level 2: 중고등학생도 이해 가능한 쉬운 말로, 핵심 개념과 이유를 포함해 2줄로 요약하세요.",
    3: "- Level 3: 고급 분석과 실전 활용 관점으로, 데이터 기반·비교·수치 등을 포함해 2줄로 요약하세요."
}
